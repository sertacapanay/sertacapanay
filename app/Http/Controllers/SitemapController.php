...
class SitemapController extends Controller
{
    public function index()
    {
        ...
        // İçerik boşken (henüz tur/cruise girilmemişken) noindex olan sayfaları
        // sitemap'e ekleme — Google noindex URL'lerin sitemap'te olmamasını önerir.
        if ($tours->isNotEmpty()) {
            $staticPages[] = ['loc' => $baseUrl.'/tr/tours', 'alt_en' => $baseUrl.'/en/tours', 'priority' => '0.7', 'changefreq' => 'monthly'];
        }
        if ($cruises->isNotEmpty()) {
            $staticPages[] = ['loc' => $baseUrl.'/tr/cruiselog', 'alt_en' => $baseUrl.'/en/cruiselog', 'priority' => '0.5', 'changefreq' => 'monthly'];
        }
